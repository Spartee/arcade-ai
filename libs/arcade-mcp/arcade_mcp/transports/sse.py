...
class SSETransport:
    ...
    This transport provides an SSE endpoint suitable for clients like Cursor
    that support SSE-based MCP connections.
    """
    ...
    def run(
        ...
        **kwargs: Any,
        ...
        # Register all toolkits from catalog
        for toolkit in self.catalog.toolkits.values():
